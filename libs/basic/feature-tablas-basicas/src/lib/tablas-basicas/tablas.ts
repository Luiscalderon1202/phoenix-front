    ...
    opciones: [
      {
        ...
        legacy: `${L}/basic/TipoOperacion.php`,
      },
      {
        icono: 'cash',
        acento: '#f59e0b',
      ...
      },
      {
        ...
        legacy: `${L}/basic/TipoTributo.php`,
      },
      {
        icono: 'x-circle',
        acento: '#ef4444',
        ...
        legacy: `${L}/inventarios/MotivoAnulacion.php`,
      },
      {
        icono: 'doc',
        acento: '#8b5cf6',
        ...
        legacy: `${L}/inventarios/MotivoNotas.php`,
      },
      {
        icono: 'grid',
        acento: '#22c55e',
        ...
        legacy: `${L}/inventarios/TipoConsumo.php`,
      },
      {
        icono: 'phone',
        acento: '#3b82f6',
        ...
        legacy: `${L}/inventarios/TipoCanal.php`,
      },
    ],
  },
  {
    ...
    opciones: [
      {
        ...
        legacy: `${L}/inventarios/EstadoProcesoPedido.php`,
      },
    ],
  },
  {
    ...
    opciones: [
      {
        ...
        legacy: `${L}/tesoreria/TipoFormaPago.php`,
      },
      {
        icono: 'credit-card',
        acento: '#6366f1',
        ...
        legacy: `${L}/tesoreria/TipoTarjeta.php`,
      },
      {
        ...
        legacy: `${L}/tesoreria/CondicionPago.php`,
      },
      {
        icono: 'bank',
        acento: '#0891b2',
        ...
        legacy: `${L}/tesoreria/TipMovCaj.php`,
      },
      {
        icono: 'receipt',
        acento: '#22c55e',
        ...
        legacy: `${L}/tesoreria/TipoDescuento.php`,
      },
    ],
  },
  {
